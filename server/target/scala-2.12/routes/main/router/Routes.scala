...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """ws""", """com.matusakfilip.kixit.controllers.Application.socket"""),
  ...
  // @LINE:7
  private[this] lazy val com_matusakfilip_kixit_controllers_Application_socket1_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("ws")))
  )
  private[this] lazy val com_matusakfilip_kixit_controllers_Application_socket1_invoker = createInvoker(
    Application_1.socket,
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "com.matusakfilip.kixit.controllers.Application",
      "socket",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:7
    case com_matusakfilip_kixit_controllers_Application_socket1_route(params@_) =>
      call { 
        com_matusakfilip_kixit_controllers_Application_socket1_invoker.call(Application_1.socket)
      }
  
    // @LINE:10
    case controllers_Assets_at2_route(params@_) =>
      call(params.fromPath[String]("file", None)) { (file) =>
        controllers_Assets_at2_invoker.call(Assets_0.at(file))
      }
